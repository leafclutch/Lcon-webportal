...
import {
  LayoutDashboard, Clock, CheckSquare, ListTodo, CalendarOff,
  MessageCircle, Megaphone, AlertTriangle, FolderOpen,
  FileText, Lightbulb, Users, Shield, X, LogOut,
} from 'lucide-react'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Announcements',  href: '/announcements',  icon: Megaphone,       always: true },
          ...
          <div className="mx-4 mb-4 rounded-xl bg-gray-800 p-3">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-xs text-gray-400">{user.role?.name ?? 'No role'}</p>
              </div>
            </div>
          </div>
        )}
